...
class Main {
	...
	public static void main(String[] args) {
		...
		while (linha != null && !linha.equals("")) {
			...
			if (nWays[numero] == 1) {
				System.out.println("There is only " + nWays[numero] + " way to produce " + numero + " cents change.");
			} else {
				System.out.println("There are " + nWays[numero] + " ways to produce " + numero + " cents change.");
			}
